		...
		<div class="container">
			...
			<div class="col-md-5">
				...
				<ul class="icons-list">
					...
					<li><i class="fa fa-tablet"></i> <strong>Teléfono:</strong> +1 786 332.28.16</li>
				</ul> 
											</div>
										</div>
									</div>
										...
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapse-5" class="collapsed">
													...
													<i class="fa fa-clock-o"></i> Horario de Trabajo
												</a>
											</h4>
										</div>
										...
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapse-6" class="collapsed">
													<i class="fa fa-angle-down control-icon"></i>
													<i class="fa fa-certificate"></i> Nuestras Oficinas
												</a>
											</h4>
										</div>
