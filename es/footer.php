        ...
        <footer>
            <div class="container">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="footer-widget contact-widget">
                            ...
                            <ul class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <li><span>Teléfono:</span> +1 786 332.28.16</li>
                                <li><span>Email:</span> info@tecnotropolisla.com</li>
                                <li><span>Dirección:</span> 2051 NW 112th, Av Suite 119. Miami, Florida. 33172 </li>
                            </ul>
                        </div>
                    </div><!-- .col-md-3 -->
                    <!-- End Contact Widget -->
                ...
                <div class="copyright-section">
                    <div class="row">
                        <div class="col-md-6">
                            <p>&copy; 2015 Tecnotropolis LLC -  All Rights Reserved</p>
                        </div><!-- .col-md-6 -->
                        <div class="col-md-6">
                            <ul class="footer-nav">
                                <li><a href="es/">Principal</a>
                                </li>
                                <li><a href="es/nosotros">Nosotros</a>
                                </li>
                                <li><a href="es/productos">Productos</a>
                                </li>
                                <li><a href="es/especiales">Especiales</a>
                                </li>
