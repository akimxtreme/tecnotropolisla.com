            ...
            <div class="container">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="footer-widget contact-widget">
                            ...
                            <ul class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <li><span>Street Address:</span> 2051 NW 112th, Av Suite 119. Miami, Florida. 33172 </li>
                            </ul>
                        </div>
                    </div><!-- .col-md-3 -->
                    <!-- End Contact Widget -->
                ...
                <div class="copyright-section">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="footer-nav">
                                <li><a href="en/">Principal</a>
                                </li>
                                <li><a href="en/we">we</a>
                                </li>
                                <li><a href="en/products">Products</a>
                                </li>
                                <li><a href="en/specials">Specials</a>
                                </li>
